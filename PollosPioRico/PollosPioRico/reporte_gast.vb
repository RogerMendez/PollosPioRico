...
Public Class reporte_gast
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PollosPioRico.reporte_gast.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporte_gast
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_gast = New reporte_gast()
        rpt.Site = Me.Site
        Return rpt
    End Function
